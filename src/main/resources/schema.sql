...
CREATE TABLE TB_HANA_MBR_SPECIFIC (
...
CREATE TABLE TB_HANA_AUTHORITIES (
    ...
    CONSTRAINT FK_SPECIFIC_IDS FOREIGN KEY(MBR_ID) REFERENCES TB_HANA_MBR(MBR_ID)
);
...
CREATE UNIQUE INDEX IX_SPEC_MBR_ID ON TB_HANA_MBR_SPECIFIC (MBR_ID,SALT);